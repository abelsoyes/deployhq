...
return [
    '.1_DoctrineProvider~zchRuuc' => true,
    '.1_LegacyRouteLoaderContainer~YtF7J3f' => true,
    '.1_NativeFileSessionHandler~0hs87tF' => true,
    '.1_NonceGenerator~59nVTUU' => true,
    '.1_ResolvedFormTypeFactory~lHrjk5l' => true,
    '.1_Serializer~T7_Q5W3' => true,
    '.1_ServiceLocator~mEF6cOY' => true,
    '.1_SourceContextProvider~DA7V4V3' => true,
    '.1_Swift_Transport_Esmtp_Auth_CramMd5Authenticator~IBjr3vp' => true,
    '.1_bool~vEHItrp' => true,
    '.1_~8XbihY0' => true,
    '.1_~o1H0y0s' => true,
    '.2_ArrayAdapter~zchRuuc' => true,
    '.2_HtmlDumper~59nVTUU' => true,
    '.2_ObjectNormalizer~T7_Q5W3' => true,
    '.2_SourceContextProvider~DA7V4V3' => true,
    '.2_Swift_Transport_Esmtp_Auth_LoginAuthenticator~IBjr3vp' => true,
    '.2_~8XbihY0' => true,
    '.2_~o1H0y0s' => true,
    '.3_RequestContextProvider~DA7V4V3' => true,
    '.3_Swift_Transport_Esmtp_Auth_PlainAuthenticator~IBjr3vp' => true,
    '.4_CliContextProvider~DA7V4V3' => true,
    '.4_Swift_Transport_Esmtp_Auth_NTLMAuthenticator~IBjr3vp' => true,
    '.5_CliDescriptor~DA7V4V3' => true,
    '.6_HtmlDescriptor~DA7V4V3' => true,
